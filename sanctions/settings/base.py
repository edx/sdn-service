...
from sanctions.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get('SANCTIONS_SECRET_KEY', 'insecure-secret-key')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'sanctions.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'sanctions_sessionid'
CSRF_COOKIE_NAME = 'sanctions_csrftoken'
LANGUAGE_COOKIE_NAME = 'sanctions_language'
