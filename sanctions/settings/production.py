...
from sanctions.settings.base import *  # pylint: disable=wildcard-import
from sanctions.settings.utils import get_env_setting
...
# This may be overridden by the YAML in sanctions_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

if 'SANCTIONS_CFG' in environ:
    CONFIG_FILE = get_env_setting('SANCTIONS_CFG')
