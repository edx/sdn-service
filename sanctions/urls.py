...
from sanctions.apps.api import urls as api_urls
from sanctions.apps.core import views as core_views
...
urlpatterns = oauth2_urlpatterns + [
    ...
    re_path(r'^api-docs/', get_swagger_view(title='sanctions API')),
