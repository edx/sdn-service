...
"""
sanctions documentation build configuration file.
...
VERSION = get_version('../sanctions', '__init__.py')
...
html_context = {
    ...
    "github_repo": 'sanctions',  # Repo name
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Backend Django IDA for checking users against Specially Designated Nationals (SDN) - Treasury Department and Nonproliferation Sanctions (ISN) - State Department, as well as managing these sanctions hit records.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'sanctions'),
                os.path.join(root_path, 'sanctions/migrations')])
